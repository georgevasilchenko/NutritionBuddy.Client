...
import {BaseCollectionItemComponent} from '../../../../frontend/components/base-components/base-collection-item/base-collection-item.component';
...
@Component({
  ...
  styleUrls: ['./product-collection-item.component.less']
})
export class ProductCollectionItemComponent extends BaseCollectionItemComponent<Product> implements OnInit, OnDestroy {
